        ...
        <div class="content-wrapper">
            <div class="container-fluid">
                                            ...
                                            <tbody>
                                                @foreach ($archived as $history)
                                                        <tr>
                                                            ...
                                                            <td>
                                                                <button type="button" class="btn btn-info" data-toggle="modal" data-target="#historyModal{{ $history->footer_id }}">
                                                                  View Info
                                                                </button>
                                                                <div class="modal fade" id="historyModal{{ $history->footer_id }}" tabindex="-1" role="dialog" aria-labelledby="historyModalLabel{{ $history->footer_id }}" aria-hidden="true">
                                                                    <div class="modal-dialog modal-dialog-scrollable" role="document">
                                                                      <div class="modal-content">
                                                                        <div class="modal-header">
                                                                          <h5 class="modal-title" id="historyModalLabel{{ $history->footer_id }}">Footer Information</h5>
                ...
                <div class="modal-dialog" role="document">
                  ...
                  {{-- imagemodal --}}
                <div class="modal fade" id="imageModal2" tabindex="-1" role="dialog" style="margin-top: 80px;"
                aria-labelledby="imageModalLabel" aria-hidden="true">
                <div class="modal-dialog" role="document">
                    <div class="modal-content" style="margin-top: 80px">
                        <div class="modal-body">
                  ...
                  {{-- imagemodal --}}
                <div class="modal fade" id="imageModal3" tabindex="-1" role="dialog" style="margin-top: 80px;"
                aria-labelledby="imageModalLabel" aria-hidden="true">
                <div class="modal-dialog" role="document">
                    <div class="modal-content" style="margin-top: 80px">
                        <div class="modal-body">
 ...
 <div class="modal-dialog" role="document">
     <div class="modal-content" style="background-color: rgb(3, 34, 3);">
         ...
         <div class="modal-body">
             <form action="{{ url('/add-history-content') }}" method="POST"
                 ...
                 <div class="form-group">
                     ...
                     <input type="text" class="form-control" id="name" name="history_desc"
                         @error('history_desc') is-invalid @enderror value="{{ old('history_desc') }}"
                 ...
                 <div class="form-group">
                     ...
                     <textarea type="text" class="form-control" id="name" name="history_info"
                         @error('history_info') is-invalid @enderror value="{{ old('history_info') }}"
         ...
         <div class="modal-footer">
            ...
            <div class="modal fade" id="editItemModal{{ $history->footer_id }}" tabindex="-1" role="dialog" aria-labelledby="editItemModalLabel" aria-hidden="true">
                <div class="modal-dialog" role="document">
                    <div class="modal-content" style="background-color: rgb(3, 34, 3);">
                        <div class="modal-header">
                        ...
                        <div class="modal-body">
                            <form action="{{ url('/update-history-footer/' . $history->footer_id) }}"
                                method="POST" enctype="multipart/form-data">
                                @csrf
                                @method('PUT')
                                <!-- Form fields -->
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" id="history_name" name="footer_title" value="{{ $history->footer_title }}" required>
                                </div>
                                <div class="form-group">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="file" class="form-control" id="footer_image1" name="footer_image1">
                                    @if ($history->footer_image1)
                                        <div class="mt-2">
                                            <label>Current Image:</label>
                                            <img src="{{ asset('footer_image1/' . $history->footer_image1) }}" class="img-thumbnail" alt="Current Image">
                                        </div>
                                    @else
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="file" class="form-control" id="footer_image2" name="footer_image2">
                                    @if ($history->footer_image2)
                                        <div class="mt-2">
                                            <label>Current Image:</label>
                                            <img src="{{ asset('footer_image2/' . $history->footer_image2) }}" class="img-thumbnail" alt="Current Image">
                                        </div>
                                    @else
                                        <p>No image available</p>
                                    @endif
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="file" class="form-control" id="footer_image3" name="footer_image3">
                                    @if ($history->footer_image3)
                                        <div class="mt-2">
                                            <label>Current Image:</label>
                                            <img src="{{ asset('footer_image3/' . $history->footer_image3) }}" class="img-thumbnail" alt="Current Image">
                                        </div>
                                    @else
                                        <p>No image available</p>
                                    @endif
            ...
            @foreach ($footer as $history)
            <div class="modal fade" id="archiveItemModal{{ $history->footer_id }}" tabindex="-1" role="dialog" aria-labelledby="archiveItemModalLabel" aria-hidden="true">
                <div class="modal-dialog" role="document">
                    <div class="modal-content" style="background-color: rgb(3, 34, 3);">
                        <div class="modal-header">
                        ...
                        <div class="modal-body">
                                ...
                                <div class="modal-footer">
                                    ...
                                    <form action="{{ url('/archive-history-content/'. $history->footer_id) }}" method="POST">
                                        @csrf
