...
<body class="bg-theme bg-theme1">
    ...
    <div id="wrapper">
        ...
        <div class="content-wrapper">
                                            ...
                                            <tbody>
                                                @foreach ($contents as $history)
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <button type="button" class="btn btn-info" data-toggle="modal" data-target="#historyModal{{ $history->history_id }}">
                                                              View Info
                                                            </button>
                                                            <div class="modal fade" id="historyModal{{ $history->history_id }}" tabindex="-1" role="dialog" aria-labelledby="historyModalLabel{{ $history->history_id }}" aria-hidden="true">
                                                                <div class="modal-dialog modal-dialog-scrollable" role="document">
                                                                  <div class="modal-content">
                                                                    <div class="modal-header">
                                                                      <h5 class="modal-title" id="historyModalLabel{{ $history->history_id }}">History Info</h5>
                                                                      <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                                                        <span aria-hidden="true">&times;</span>
                                                                      </button>
                                                                    </div>
                                                                    <div class="modal-body" style="color: black; overflow-y: auto; max-height: 400px;" >
                                                                      <pre>{{ $history->history_info }}</pre>
                                                                    </div>
            ...
            @foreach ($contents as $history)
            <div class="modal fade" id="archiveItemModal{{ $history->history_id }}" tabindex="-1" role="dialog" aria-labelledby="archiveItemModalLabel" aria-hidden="true">
                <div class="modal-dialog" role="document">
                    <div class="modal-content" style="background-color: rgb(3, 34, 3);">
                        <div class="modal-header">
                        ...
                        <div class="modal-body">
                                <p>Are you sure you want to archive the category: {{ $history->history_title }}?</p>
                                <div class="modal-footer">
                                    <button type="button" class="btn btn-secondary" data-dismiss="modal">Cancel</button>
                                    <form action="{{ url('/archive-history-content/'. $history->history_id) }}" method="POST">
                                        @csrf
