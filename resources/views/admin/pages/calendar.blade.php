    ...
    <li class="nav-item">
      ...
      <ul class="dropdown-menu dropdown-menu-right">
       <li class="dropdown-item user-details">
        ...
        <li class="dropdown-item"><i class="zmdi zmdi-account"></i><a href="{{asset("admin/profile")}}"> Account</li></a>
        <li class="dropdown-divider"></li>
        <li class="dropdown-item"><i class="zmdi zmdi-power"></i><a href="{{asset("logout")}}"> Logout</li></a>
      </ul>
    </li>
  </ul>
</nav>
