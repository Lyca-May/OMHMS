        ...
        <header id="header" class="header">
            <div class="top-left">
                <div class="navbar-header">
                    ...
                    {{-- <a class="navbar-brand hidden" href="./"><img src="omhms.png" alt="Logo"></a> --}}
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    @if ($functional->functional_status == 'PENDING')
                                                        <p><span style="background-color: black">{{ $functional->functional_status }}</span></p>
                                                    @else
                                                        <p><span style="background-color: green">{{ $functional->functional_status }}</span></p>
                                                    @endif
                                                </td>
