                ...
                <div class="row">
                    ...
                    <div class="row">
                        <div class="col-12 col-lg-12">
                            <div class="card">
                                <div class="card-header">List of Rent's Sales
                                    <br>
                                    <br>
                                </div>
                                    ...
                                    <table class="table align-items-center table-flush table-borderless"
                                        ...
                                        <thead>
                                            <tr>
                                                ...
                                                <th>Chairs</th>
                                                <th>Other Service</th>
                                                <th>Payment for Chosen Facility</th>
                                                <th>Payment for Additional Service</th>
                                                <th>Payment for Other Service</th>
                                                <th>DownPayment</th>
                                                <th>Recorded date</th>
                                                <th>Recorded by</th>
                                                <th>Approved by</th>
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    @if ($sale->rent_hall->sound_system == 1)
                                                        <span>AVAILED</span>
                                                    @else
                                                    <span>DIDN'T AVAIL</span>

                                                    @endif
                                                </td>
                                                <td>
                                                    @if ($sale->rent_hall->led_tv == 1)
                                                        <span>AVAILED</span>
                                                    @else
                                                    <span>DIDN'T AVAIL</span>
                                                ...
                                                <td>
                                                    @if ($sale->rent_hall->microphones == 1)
                                                        <span>AVAILED</span>
                                                    @else
                                                    <span>DIDN'T AVAIL</span>
                                                ...
                                                <td>
                                                    @if ($sale->rent_hall->others !=null)
                                                    <span>{{$sale->rent_hall->others}}</span>
                                                    @else
                                                    <span>NONE</span>
                                                    @endif
                                                </td>
                                                <td>{{ $sale->rent_hall->payment_rent}}</td>
                                                <td>{{ $sale->rent_hall->add_service_payment}}</td>
                                                <td>
                                                    @if ($sale->rent_hall->others_payment !=null)
                                                        <span>{{ $sale->rent_hall->others_payment}}</span>
                                                    @else
                                                    <span>NONE</span>
                                                    @endif
                                                </td>
                                                <td>{{ $sale->rent_hall->downpayment}}</td>
                                                <td>{{ $sale->rent_hall->recorded_date}}</td>
                                                <td>{{ $sale->rent_hall->recorded_by}}</td>
                                                <td>{{ $sale->rent_hall->approved_by}}</td>
                                                <td>{{ $sale->rent_hall->total_payment }}</td>
