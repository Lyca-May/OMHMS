                ...
                <div class="login-form">
                    ...
                    <form action="{{url('auth/confirm-reset')}}" method="POST">
                        ...
                        <div class="form-group">
                            ...
                            <input type="password" class="form-control" placeholder="New Password" name="password" value="{{old('password')}} " class="@error('password')is-invalid @enderror" autocomplete="on">
                            <input type="hidden" name="token" value="{{session('token')}} " autocomplete="on">
                            @error('password')
                            <span style="color: red">{{$message}}</span>
                            @enderror
                        ...
                        <div class="form-group">
                            ...
                            <input type="password" class="form-control" placeholder="New Password" name="password_confirmation" value="{{old('password_confirmation')}} " class="@error('password_confirmation')is-invalid @enderror" autocomplete="on">
                            @error('password_confirmation')
                            <span style="color: red">{{$message}}</span>
                            @enderror
                        </div>
