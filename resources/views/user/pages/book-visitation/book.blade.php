                                ...
                                <div class="row">
                                    ...
                                    <div class="col">
                                        <div class="form-group">
                                            ...
                                            <div class="input-group">
                                                <div class="input-group-addon"></div>
                                                <input type="text" class="form-control" placeholder="Middle Name" name="visits_mname"  @error('visits_mname') is-invalid  @enderror id="visits_mname" value="{{ session('User')['user_mname'] }}" >
                                                @error('visits_mname')
                                                    <div class="invalid-feedback">{{ $message }}</div>
                                                @enderror <br>
                                            </div>
                                    ...
                                    <div class="col">
                                        <div class="form-group">
                                            ...
                                            <div class="input-group">
                                                <div class="input-group-addon"></div>
                                                <input type="text"  class="form-control" placeholder="Last Name" name="visits_lname"  @error('visits_lname') is-invalid  @enderror id="visits_lname" value="{{ session('User')['user_lname'] }}" >
                                                @error('visits_lname')
                                                    <div class="invalid-feedback">{{ $message }}</div>
                                                @enderror <br>
                                            </div>
                                ...
                                <div class="row">
                                    <div class="col">
                                        <div class="form-group">
                                            ...
                                            <div class="input-group">
                                                <div class="input-group-addon"></div>
                                                <input type="text"  class="form-control" placeholder="Country" name="visits_country"  @error('visits_country') is-invalid  @enderror id="visits_country" value="{{ session('User')['user_country'] }}" >
                                    ...
                                    <div class="col">
                                        <div class="form-group">
                                            ...
                                            <div class="input-group">
                                                <div class="input-group-addon"></div>
                                                <input type="text" class="form-control"  placeholder="Province" name="visits_province"  @error('visits_province') is-invalid  @enderror id="visits_province" value="{{ session('User')['user_province'] }}" >
                                    ...
                                    <div class="col">
                                        <div class="form-group">
                                            ...
                                            <div class="input-group">
                                                ...
                                                <input type="text" class="form-control" placeholder="Municipality" name="visits_municipality"  @error('visits_municipality') is-invalid  @enderror id="visits_municipality" value="{{ session('User')['user_municipality'] }}" >
                                    ...
                                    <div class="col">
                                        <div class="form-group">
                                            ...
                                            <div class="input-group">
                                                ...
                                                <input type="text" class="form-control" placeholder="Barangay" name="visits_brgy"  @error('visits_brgy') is-invalid  @enderror id="visits_brgy" value="{{ session('User')['user_barangay'] }}" >
                                                @error('visits_brgy')
                                                    <div class="invalid-feedback">{{ $message }}</div>
                                                @enderror <br>
                                            </div>
                                    ...
                                    <div class="row">
                                        <div class="col">
                                            <div class="form-group">
                                                ...
                                                <div class="input-group">
                                                    <div class="input-group-addon"></div>
                                                    <input type="text" class="form-control" placeholder="Street" name="visits_street" @error('visits_street') is-invalid  @enderror id="visits_street" value="{{ session('User')['user_street'] }}" >
                                                    @error('visits_street')
                                                        <div class="invalid-feedback">{{ $message }}</div>
                                                    @enderror <br>
                                                </div>
                                        ...
                                        <div class="col">
                                            <div class="form-group">
                                                <label class=" form-control-label">Intended Date of Visit</label>
                                                <div class="input-group">
                                                    <div class="input-group-addon"></div>
                                                    <input type="date"  class="form-control" placeholder="Intended Date" name="visits_intended_date" @error('visits_intended_date') is-invalid  @enderror id="visits_intended_date" value="{{ old('visits_intended_date') }}" >
                                        ...
                                        <div class="col">
                                            <div class="form-group">
                                                <label class=" form-control-label">Time of Visit</label>
                                                <div class="input-group">
                                                    <div class="input-group-addon"></div>
                                    ...
                                    <div>
                                        <a href="{{ url('user/home') }}"><button class="btn-primary" type="submit">Submit</button></a>
                                    </div>
                                </div>
                            </div>
                        </div>
