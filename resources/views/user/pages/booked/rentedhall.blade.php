                                    ...
                                    <div class="panel-body">
                                        <div class="invoice-ribbon">
                                            <div class="ribbon-inner">
                                                ...
                                                <p> <span style="color:black; font-weight:bold">{{ $functional->functional_status }}</span></p>
                                                ...
                                                <p class="lead marginbottom"><strong>From : Oriental Mindoro Heritage Museum</strong></p>
                                                    ...
                                                    <div class="post" style="line-height: 20px">
                                                        ...
                                                        @if ($functional->functional_name_of_institution != null)
                                                            <p>You are from {{ $functional->functional_name_of_institution }} Institution and you're with your {{ $functional->functional_no_of_participants }} members</p>
                                                        @endif
                                                       <p>Event Name: {{ $functional->functional_event_name }}</p>
                                                        {{-- <p> Due to:</p> --}}
