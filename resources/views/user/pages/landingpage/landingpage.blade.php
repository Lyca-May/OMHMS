            ...
            <div class="hotel_booking_area position">
                <div class="container">
                    <div class="hotel_booking_table">
                        ...
                        <br>
                        <a class="book_now_btn button_hover" href="{{ url('auth/login') }}"
                            style="width:1040px">Book Now</a>
                ...
                <div id="Surat" class="tabcontent">
                    <div class="tab-content">
                        ...
                        <div class="tab-content-right">
                            ...
                            <p style="text-align: justify">Among the notable aspects of the Hanunuo Mangyan's rich
                                culture is their writing system
